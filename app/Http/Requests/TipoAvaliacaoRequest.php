...
class TipoAvaliacaoRequest extends FormRequest {
    /**
...
//        return [
//            'id'                                    => 'nullable|integer',
//            'nome'                                  => 'nullable|string|max:120|unique:tipos_avaliacoes,nome',
//            'descricao'                             => 'nullable|string|max:255|unique:tipos_avaliacoes,descricao',
//            'inativo'                               => 'required|boolean',
//            'traducoes'                             => 'required|array',
//            'traducoes.*.id'                        => 'required|integer|exists:traducoes,id',
...
//            'traducoes.*.nome'                      => 'required|string|max:255|unique:traducoes,nome',
//            'traducoes.*.descricao'                 => 'required|string|max:255|unique:traducoes,descricao'
//        ];
//    }

    public function rules(){
        $rules =  [
            'nome'                                  => 'string|max:120|unique:tipos_avaliacoes,nome,'.$this->id,
            'descricao'                             => 'string|max:255|unique:tipos_avaliacoes,descricao,'.$this->id,
        ...
        for ($i = 0; $i < count($this->traducoes); $i++) {
            if($this->update) {
                $rules['id']                            = 'required|integer|exists:tipos_avaliacoes,id';
    ...
    public function messages() {
        return [
            'nome.required'         => 'A Tipo de Avaliação é de preenchimento obrigatório.',
