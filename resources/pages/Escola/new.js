                ...
                <Form.Group widths="equal">
                  <Field name="indexCode">
                    {({ input: indexCodeInput }) => (
                      <Form.Input
                        label="Index coluna Código Curso"
                        {...indexCodeInput}
                      />
                    )}
                  </Field>
                  ...
                  <Field name="indexCodeUC">
                    {({ input: indexCodeUCInput }) => (
                      <Form.Input
                        label="Index coluna Código Unidade Curricular"
                        {...indexCodeUCInput}
                      />
                    )}
                  </Field>
                ...
                <Form.Group widths="equal">
                  <Field name="indexNameUC">
                    {({ input: indexNameUCInput }) => (
                      <Form.Input
                        label="Index coluna Nome Unidade Curricular"
                        {...indexNameUCInput}
                      />
                    )}
                  </Field>
                  <Field name="indexTeachers">
                    {({ input: indexTeachersInput }) => (
                      <Form.Input
                        label="Index coluna Professores do curso"
                        {...indexTeachersInput}
                      />
                    )}
                  </Field>
                  <Field name="indexYear">
                    {({ input: indexYearInput }) => (
                      <Form.Input
                        label="Index coluna Ano curricular da Unidade Curricular"
                        {...indexYearInput}
                      />
                    )}
                  </Field>
                ...
                <Form.Group widths="equal">
                  <Field name="academicYearQueryParam">
                    {({ input: anoletivoInput }) => (
                      <Form.Input
                        label="Nome do parâmetro para o ano letivo"
                        {...anoletivoInput}
                      />
                    )}
                  </Field>
                  <Field name="semesterQueryParam">
                    {({ input: semestreInput }) => (
                      <Form.Input
                        label="Nome do parâmetro para o semestre"
                        {...semestreInput}
                      />
                    )}
                  </Field>
