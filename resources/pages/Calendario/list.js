...
const List = ({ match }) => {
  ...
  const columns = [
    ...
    { name: 'Estado' },
    {
      name: 'Publicado?', textAlign: 'center', restrictedToCreators: true, permission: SCOPES.VIEW_CALENDAR_INFO,
    },
    { name: 'Fase', restrictedToCreators: true, permission: SCOPES.VIEW_ACTUAL_PHASE },
    { name: 'Ações' },
  ];
